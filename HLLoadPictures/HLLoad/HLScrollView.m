...
@interface HLScrollView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
{
    HLScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[HLCollectionViewCell class] forCellWithReuseIdentifier:ID];
